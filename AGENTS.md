...
This project is indexed by GitNexus as **HoTools** (15588 symbols, 33116 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
