...
from . import boneCollisionArmature,boneHumanoid,boneOperators,boneProperty,boneRename,boneSplit,boneDissolve
...
def register():
    ...
    boneCollisionArmature.register()
...
def unregister():
    boneCollisionArmature.unregister()
