...
def _refresh_checker(context):
    """Refresh active Checker previews without retaining Checker state here."""
    try:
        from .. import Checker
        Checker.refresh_all(context)
    except Exception:
        # Keep vertex-group operators usable when this module is tested alone.
        return
