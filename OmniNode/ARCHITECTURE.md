...
- MC2 self primitive、contact cache与intersect record都属于slot-owned native context。当前只完成Point→Edge→Triangle静态注册；空contact/intersect容器不得被解释为self-collision求解已启用。
