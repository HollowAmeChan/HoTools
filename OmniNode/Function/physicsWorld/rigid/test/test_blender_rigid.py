...
# ── 路径根 ────────────────────────────────────────────────────────────────────
_HOTOOLS  = os.path.abspath(os.path.join(os.path.dirname(__file__), *("..",) * 5))
...
# from ...OmniNodeSocketMapping  在 HoTools.OmniNode.Function.physicsWorld.world
# level=3 → HoTools.OmniNode.OmniNodeSocketMapping  ← 文件真实存在  ✓
...
def _register_physics_props():
    ...
    from HoTools.OmniNode.Function.physicsWorld.collision.properties import (
        PG_Hotools_ObjectCollision,
    )
    from HoTools.OmniNode.Function.physicsWorld.rigid.properties import (
...
# 模块名前缀：HoTools.OmniNode.Function.physicsWorld.*
# from ...OmniNodeSocketMapping (level=3) 解析到 HoTools.OmniNode.OmniNodeSocketMapping ✓

_PKG_PREFIX = "HoTools.OmniNode.Function.physicsWorld"
...
_pkg_dirs = [
    ...
    ("HoTools.OmniNode.Function.physicsWorld", _PW_ROOT),
    ("HoTools.OmniNode.Function.physicsWorld.utils",
         os.path.join(_PW_ROOT, "utils")),
    ("HoTools.OmniNode.Function.physicsWorld.collision",
         os.path.join(_PW_ROOT, "collision")),
    ("HoTools.OmniNode.Function.physicsWorld.spring_vrm",
         os.path.join(_PW_ROOT, "spring_vrm")),
    ("HoTools.OmniNode.Function.physicsWorld.rigid",
         os.path.join(_PW_ROOT, "rigid")),
    ("HoTools.OmniNode.Function.physicsWorld.rigid.backends",
