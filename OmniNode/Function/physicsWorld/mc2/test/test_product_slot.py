...
for package_name, package_path in (
    ...
    ("HoTools.OmniNode.Function.physicsWorld.mc2", MC2_ROOT),
    ("HoTools.OmniNode.Function.physicsWorld.mc2.setups", os.path.join(MC2_ROOT, "setups")),
    (
        "HoTools.OmniNode.Function.physicsWorld.mc2.setups.mesh_cloth",
...
world_types = importlib.import_module("HoTools.OmniNode.Function.physicsWorld.types")
ir = importlib.import_module("HoTools.OmniNode.Function.physicsWorld.mc2.domain_ir")
collector = importlib.import_module("HoTools.OmniNode.Function.physicsWorld.mc2.domain_collect")
parameters = importlib.import_module("HoTools.OmniNode.Function.physicsWorld.mc2.parameters")
partitions = importlib.import_module("HoTools.OmniNode.Function.physicsWorld.mc2.partition_specs")
product = importlib.import_module("HoTools.OmniNode.Function.physicsWorld.mc2.setups.mesh_cloth.product")
slot_module = importlib.import_module("HoTools.OmniNode.Function.physicsWorld.mc2.product_slot")
product_frame_module = importlib.import_module(
    "HoTools.OmniNode.Function.physicsWorld.mc2.setups.mesh_cloth.product"
)
collider_module = importlib.import_module("HoTools.OmniNode.Function.physicsWorld.mc2.collider_frame")
native_kernel_module = importlib.import_module(
    "HoTools.OmniNode.Function.physicsWorld.mc2.cpu_native_kernel"
)
debug_module = importlib.import_module(
    "HoTools.OmniNode.Function.physicsWorld.mc2.debug"
)
