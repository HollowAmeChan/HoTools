...
compile_module = importlib.import_module("HoTools.OmniNode.Function.physicsWorld.mc2.domain_compile")
...
product_frame = importlib.import_module("HoTools.OmniNode.Function.physicsWorld.mc2.setups.mesh_cloth.product")
