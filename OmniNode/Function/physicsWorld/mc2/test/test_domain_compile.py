...
ir = importlib.import_module(
    "HoTools.OmniNode.Function.physicsWorld.mc2.domain_ir"
)
...
runtime = importlib.import_module(
    "HoTools.OmniNode.Function.physicsWorld.mc2.runtime_parameters"
)
partition_specs = importlib.import_module(
    "HoTools.OmniNode.Function.physicsWorld.mc2.partition_specs"
)
