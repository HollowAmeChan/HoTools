...
_pkg_dirs = [
    ...
    ("HoTools.OmniNode.Function.physicsWorld.utils", os.path.join(_PW_ROOT, "utils")),
    ("HoTools.OmniNode.Function.physicsWorld.collision", os.path.join(_PW_ROOT, "collision")),
    ("HoTools.OmniNode.Function.physicsWorld.rigid", os.path.join(_PW_ROOT, "rigid")),
    ("HoTools.OmniNode.Function.physicsWorld.spring_vrm", os.path.join(_PW_ROOT, "spring_vrm")),
]
