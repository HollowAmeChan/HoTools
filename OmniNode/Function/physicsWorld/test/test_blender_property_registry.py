...
for package_name, package_path in (
    ...
    ("HoTools.OmniNode.Function.physicsWorld", PW_ROOT),
):
...
physics_utils = importlib.import_module(
    "HoTools.OmniNode.Function.physicsWorld.ui.utils"
)
collision_property = importlib.import_module(
    "HoTools.OmniNode.Function.physicsWorld.collision.properties"
)
rigid_property = importlib.import_module(
    "HoTools.OmniNode.Function.physicsWorld.rigid.properties"
)
rigid_schema = importlib.import_module(
    "HoTools.OmniNode.Function.physicsWorld.rigid.schema"
)
rigid_capabilities = importlib.import_module(
    "HoTools.OmniNode.Function.physicsWorld.rigid.capabilities"
)
mesh_property = importlib.import_module(
    "HoTools.OmniNode.Function.physicsWorld.mc2.setups.mesh_cloth.properties"
)
mesh_schema = importlib.import_module(
    "HoTools.OmniNode.Function.physicsWorld.mc2.setups.mesh_cloth.schema"
)
mesh_capabilities = importlib.import_module(
    "HoTools.OmniNode.Function.physicsWorld.mc2.setups.mesh_cloth.capabilities"
)
collision_groups = importlib.import_module(
    "HoTools.OmniNode.Function.physicsWorld.collision.groups"
)
blender_registry = importlib.import_module(
    "HoTools.OmniNode.Function.physicsWorld.blender_registry"
)
solver_registry = importlib.import_module(
    "HoTools.OmniNode.Function.physicsWorld.registry"
)
solver_declarations = importlib.import_module(
    "HoTools.OmniNode.Function.physicsWorld.declarations"
)
world_names = importlib.import_module(
    "HoTools.OmniNode.Function.physicsWorld.names"
)
mc2_names = importlib.import_module(
    "HoTools.OmniNode.Function.physicsWorld.mc2.names"
)
