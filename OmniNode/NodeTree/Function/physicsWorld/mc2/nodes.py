...
@omni(
    ...
    is_output_node=False,
    _INPUT_NAME=[
        "物理世界", "任务筛选", "最大显示项", "拓扑连接", "BoneCloth横向连接", "Fixed/Move",
        "StepBasic参考姿态", "有效重力", "粒子速度", "Distance误差", "Tether范围",
        "Bending约束", "Motion BasePosition", "Motion约束",
        "Angle恢复目标", "Angle限制范围", "Center/Teleport", "外部碰撞", "Edge碰撞代理", "粒子半径",
    ...
    input_init={
        ...
        "show_bonecloth_lateral": {"description": "只显示HoTools BoneCloth横向连接的真实作用域。\n青色=显式横向Distance边\n紫色=三角化补出的跨链proxy边\n蓝色=横跨骨链的triangle。"},
        ...
        "show_edge_collision": {"description": "碰撞模式为2:Edge时显示内核实际消费的proxy边与插值半径。\n橙色=普通边\n青色=显式横向边\n紫色=横向triangle补出的跨链边。"},
...
def physicsMC2DebugDraw(
    ...
    update_mc2_debug_draw_store(
        ...
        show_bonecloth_lateral=show_bonecloth_lateral,
        ...
        show_edge_collision=show_edge_collision,
