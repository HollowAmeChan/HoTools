...
_EXPORTS = {
    ...
    "MC2BoneTriangleRotationResult": ".bone_rotation",
    "evaluate_mc2_bone_line_rotation": ".bone_rotation",
    "evaluate_mc2_bone_triangle_rotation": ".bone_rotation",
    "MC2BoneStaticSpec": ".bone_static",
    ...
    "bone_cloth_static_input_signature_for_task": ".setups.bone_cloth.static_build",
    ...
    "MC2ProxyStaticSpec": ".static_data",
    "pack_mc2_baseline_static": ".static_data",
    "pack_mc2_proxy_finalizer_static": ".static_data",
    "pack_mc2_proxy_static": ".static_data",
