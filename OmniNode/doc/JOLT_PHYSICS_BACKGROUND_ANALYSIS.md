...
| SixDOF | 每个平移/旋转轴自由、固定或限制；每轴摩擦、translation spring、每轴 motor | 已接显式/生成约束、spec/adapter、六轴 Free/Fixed/Limited 和调试；motor/friction 待接 |
