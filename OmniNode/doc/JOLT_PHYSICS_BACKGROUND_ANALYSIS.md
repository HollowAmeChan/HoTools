...
当前 native binding 的 P0 semantic fixture 已达到 py311/py313 各 56/56，同进程双世界重放通过；旧式 Blender 后台集成测试在 2026-07-11 实跑为 28/28。两组结果分别证明 S1 native 语义和现有 Blender 链路可运行，但还没有证明公共 spec/adapter 映射与完整 Blender pipeline 和 S1 一致。
