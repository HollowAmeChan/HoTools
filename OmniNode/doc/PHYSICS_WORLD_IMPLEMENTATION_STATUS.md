...
2. MC2 按 `MC2_SOURCE_ALIGNMENT_EXECUTION_PLAN.md` 将已冻结的Bone Line static bundle接入Blender selection、slot与staged native最小上传面；Automatic/Sequential须先解决零UV triangle basis退化，禁止按旧 solver 或未验证近似扩展 spec。
