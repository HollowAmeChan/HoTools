...
2. MC2 按 `MC2_SOURCE_ALIGNMENT_EXECUTION_PLAN.md` 优先建立含constraint/post commit的完整粒子/Center frame Tier A闭环；禁止按旧 solver 或未验证近似扩展 spec。
