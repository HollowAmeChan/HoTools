...
2. MC2 按 `MC2_SOURCE_ALIGNMENT_EXECUTION_PLAN.md` 优先收口baseline/negative-scale组合，再评估Keep+negative多子步/world-inertia组合；禁止按旧 solver 或未验证近似扩展 spec。
