...
2. MC2 按 `MC2_SOURCE_ALIGNMENT_EXECUTION_PLAN.md` 优先冻结Bone selection/proxy static，再设计native最小上传面；禁止按旧 solver 或未验证近似扩展 spec。
