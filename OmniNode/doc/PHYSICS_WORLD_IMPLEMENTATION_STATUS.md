...
2. MC2 按 `MC2_SOURCE_ALIGNMENT_EXECUTION_PLAN.md` 评估父级/shear负缩放的source contract与Blender adapter边界；禁止按旧 solver 或未验证近似扩展 spec。
