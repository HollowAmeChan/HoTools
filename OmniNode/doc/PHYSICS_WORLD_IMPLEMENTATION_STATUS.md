...
2. MC2 按 `MC2_SOURCE_ALIGNMENT_EXECUTION_PLAN.md` 将已上传native的Bone Line static连接到Line rotation/private candidate，再设计`bone_transform`发布与统一PoseBone writeback；Automatic/Sequential须先解决零UV triangle basis退化。
