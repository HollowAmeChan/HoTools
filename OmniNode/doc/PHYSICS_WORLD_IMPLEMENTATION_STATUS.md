...
2. MC2 按 `MC2_SOURCE_ALIGNMENT_EXECUTION_PLAN.md` 优先冻结Bone selection/proxy static与triangle rotation override；禁止按旧 solver 或未验证近似扩展 spec。
