...
2. MC2 按 `MC2_SOURCE_ALIGNMENT_EXECUTION_PLAN.md` 优先冻结Bone 120度边界、selection/proxy static与connection-aware rotation Tier A contract；禁止按旧 solver 或未验证近似扩展 spec。
