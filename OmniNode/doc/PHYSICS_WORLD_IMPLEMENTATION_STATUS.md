...
2. MC2 按 `MC2_SOURCE_ALIGNMENT_EXECUTION_PLAN.md` 继续让solver驱动scheduler plan/advance与native多子步循环，并收口configured teleport/negative-scale组合与baseline/negative-scale组合；禁止按旧 solver 或未验证近似扩展 spec。
