...
5. 粒子级隐式/显式resolved intent、provenance、partition filter与domain draft编译入口已闭环；当前入口由E4/P2先接多source capture/fragment cache，再合并context、whole-domain self和差异化参数。每个子交付独立做单/双source oracle。
