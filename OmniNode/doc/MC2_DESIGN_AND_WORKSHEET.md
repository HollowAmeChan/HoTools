...
| P1 | 继续收敛 MC2 参数面与上下文语义。 | damping 与 angle attenuation/falloff 已按值+曲线接入；radius 暂保持 mesh/顶点组语义。后续重点转向 external base pose rotation、negative scale、anchor/velocityWeight 等上下文缺口。 |
