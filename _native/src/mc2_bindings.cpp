...
void hotools::bind_mc2(nb::module_& m) {
    ...
    m.def("mc2_context_v0_read_debug_distance_results",
        [](nb::args a) { call_pyobject_api(hotools::mc2_context_v0_read_debug_distance_results, a); });
    m.def("mc2_context_v0_read_debug_bending_results",
